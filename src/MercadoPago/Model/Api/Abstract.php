 ...
 *
 */
abstract class MercadoPago_Model_Api_Abstract extends Varien_Object
{
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('mercadopago/wpp/'.$key);
    ...
    {
        return Mage::getUrl($this->getConfigData('api_error_url', 'mercadopago/express/error'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_return_url', 'mercadopago/express/return'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_cancel_url', 'mercadopago/express/cancel'));
    }
    ...
    {
        $types = array('AE'=>Mage::helper('mercadopago')->__('Amex'), 'VI'=>Mage::helper('mercadopago')->__('Visa'), 'MC'=>Mage::helper('mercadopago')->__('MasterCard'), 'DI'=>Mage::helper('mercadopago')->__('Discover'));
